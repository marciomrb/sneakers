        ...
        <div className="gridProduct">
          ...
          <div className="slideProduct">  
            ...
            <Swiper modules={[Thumbs, Navigation]} watchSlidesProgress onSwiper={setThumbsSwiper} className='thumbProduct'>
              ...
              <SwiperSlide><img src="/image-product-4-thumbnail.jpg" alt="product image"/></SwiperSlide>
          ...
          <div className="infoProduct">
            ...
            <div className="buttons">
              <div className="buttonsAddRemove">
                <button onClick={() => setAddMore(addMore - 1)} disabled={addMore <= 1}><img src="/icon-minus.svg" alt="" /></button>
                <span>{addMore}</span>
                <button onClick={() => setAddMore(addMore + 1)}><img src="/icon-plus.svg" alt="" /></button>
              </div>
